...
export const notification_methode = [ 
    {
        id: 1,
        value: 'sms',
        name: 'SMS',
...
export const events_type =
    [
        {id:1,value: "allEvents", name: "Tous les événements"},
        {id:2,value: "commandResult", name: "Résultat de la commande"},
        {id:3,value: "deviceOnline", name: "Statut: en ligne"},
        {id:4,value: "deviceUnknown", name: "Statut: inconnu"},
        {id:5,value: "deviceOffline", name: "Statut: hors ligne"},
        {id:6,value: "deviceInactive", name: "Appareil inactif"},
        {id:7,value: "queuedCommandSent", name: "Queued command sent"},
        {id:8,value: "deviceMoving", name: "Appareil en mouvement"},
        {id:9,value: "deviceStopped", name: "Appareil arrêté"},
        {id:10,value: "deviceOverspeed", name: "Vitesse limite dépassée"},
        {id:11,value: "deviceFuelDrop", name: "Perte de carburant"},
        {id:12,value: "deviceFuelIncrease", name: "Ajout de carburant"},
        {id:13,value: "geofenceEnter", name: "Entrée dans le périmètre virtuel"},
        {id:14,value: "geofenceExit", name: "Sortie du périmètre virtuel"},
        {id:15,value: "alarm", name: "Alarme"},
        {id:16,value: "ignitionOn", name: "Contact mis"},
        {id:17,value: "ignitionOff", name: "Contact coupé"},
        {id:18,value: "maintenance", name: "Entretien requis"},
        {id:19,value: "textMessage", name: "Message textuel reçu"},
        {id:20,value: "driverChanged", name: "Changement de conducteur"},
        {id:21,value: "media", name: "Média"}
    ];
