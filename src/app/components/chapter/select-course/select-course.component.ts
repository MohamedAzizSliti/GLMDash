...
export class SelectCourseComponent {
    ...
    public tableConfig: TableConfig = {
        columns: [
            { title: "Thumbnail", dataField: "product_thumbnail", class: 'tbl-image', type: 'image', placeholder: 'assets/images/product.png' },
            { title: "Course Name", dataField: "title", sortable: true, sort_direction: 'desc' },
            { title: "Category", dataField: "category_lbl",  sortable: true, sort_direction: 'desc' },
    ...
    edit(data: Product) {
        this.router.navigateByUrl(`chapter/list/${data.id}`);
    }
