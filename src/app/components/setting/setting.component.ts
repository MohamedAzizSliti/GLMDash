  ...
  constructor(private store: Store,
    ...
    this.form = formBuilder.group({
      general: new FormGroup({
        ...
        price_diesel: new FormControl(),
        price_essence: new FormControl(),
        speed_max: new FormControl('150', Validators.required),
      ...
      google_cloud: new FormGroup({
        activate_direction_api: new FormControl(false),
    ...
    this.store.select(SettingState.backEndSetting).subscribe(option => {
      this.form.patchValue({
        general: {
          ...
          price_diesel: option?.general?.price_diesel,
          price_essence: option?.general?.price_essence,
          speed_max: option?.general?.speed_max,
        ...
        google_cloud:  {
          activate_direction_api: option?.google_cloud?.activate_direction_api,
          api_key: option?.google_cloud?.api_key
        } ,
        activation: {
        ...
        payment_methods: {
          ...
          phonepe: {
            ...
            salt_Key: option?.payment_methods?.phonepe?.salt_Key,
