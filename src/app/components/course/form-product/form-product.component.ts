...
export class FormProductComponent {
  ...
  public html = '';
  public notification_methode = data.notification_methode;
  public selectedMethodeNotif: number[] = [];
  ...
  constructor(private store: Store,
   ...
   this.store.dispatch(new GetCategories({type: 'product', status: 1}));
    ...
    this.form = this.formBuilder.group({
      ...
      product_video_id: new FormControl(),
  ...
  ngOnInit() {
    ...
    this.form.controls['type'].valueChanges.subscribe(value => {
      if(value == 'simple') {
        ...
        this.form.setControl('is_external', new FormControl(0));
        this.form.controls['is_external'].valueChanges.subscribe(value => {
          if(value == true) {
            this.form.setControl('external_url', new FormControl('', [Validators.required]));
            this.form.setControl('external_button_text', new FormControl());
          } else {
            this.form.removeControl('external_url');
            this.form.removeControl('external_button_text');
          }
        });
        ...
        this.form.removeControl('is_external');
        this.form.removeControl('external_url');
        this.form.removeControl('external_button_text');
      }
    });
